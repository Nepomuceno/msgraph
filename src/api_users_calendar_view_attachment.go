...
// UsersCalendarViewAttachmentApiService UsersCalendarViewAttachmentApi service
type UsersCalendarViewAttachmentApiService service
...
*/
func (a *UsersCalendarViewAttachmentApiService) UsersCalendarViewCreateAttachments(ctx _context.Context, userId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *UsersCalendarViewAttachmentApiService) UsersCalendarViewGetAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, localVarOptionals *UsersCalendarViewGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersCalendarViewAttachmentApiService) UsersCalendarViewListAttachments(ctx _context.Context, userId string, eventId string, localVarOptionals *UsersCalendarViewListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersCalendarViewAttachmentApiService) UsersCalendarViewUpdateAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
