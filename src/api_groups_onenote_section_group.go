...
// GroupsOnenoteSectionGroupApiService GroupsOnenoteSectionGroupApi service
type GroupsOnenoteSectionGroupApiService service
...
*/
func (a *GroupsOnenoteSectionGroupApiService) GroupsOnenoteCreateSectionGroups(ctx _context.Context, groupId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/sectionGroups"
...
// GroupsOnenoteGetSectionGroupsOpts Optional parameters for the method 'GroupsOnenoteGetSectionGroups'
type GroupsOnenoteGetSectionGroupsOpts struct {
 ...
 * @param optional nil or *GroupsOnenoteGetSectionGroupsOpts - Optional Parameters:
...
@return MicrosoftGraphSectionGroup
*/
func (a *GroupsOnenoteSectionGroupApiService) GroupsOnenoteGetSectionGroups(ctx _context.Context, groupId string, sectionGroupId string, localVarOptionals *GroupsOnenoteGetSectionGroupsOpts) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/sectionGroups({sectionGroup-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"group-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", groupId)), -1)
...
// GroupsOnenoteListSectionGroupsOpts Optional parameters for the method 'GroupsOnenoteListSectionGroups'
type GroupsOnenoteListSectionGroupsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId key: group-id of group
 * @param optional nil or *GroupsOnenoteListSectionGroupsOpts - Optional Parameters:
...
*/
func (a *GroupsOnenoteSectionGroupApiService) GroupsOnenoteListSectionGroups(ctx _context.Context, groupId string, localVarOptionals *GroupsOnenoteListSectionGroupsOpts) (CollectionOfSectionGroup, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsOnenoteSectionGroupApiService) GroupsOnenoteUpdateSectionGroups(ctx _context.Context, groupId string, sectionGroupId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (*_nethttp.Response, error) {
	var (
