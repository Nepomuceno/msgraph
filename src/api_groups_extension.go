...
*/
func (a *GroupsExtensionApiService) GroupsCreateExtensions(ctx _context.Context, groupId string, microsoftGraphExtension MicrosoftGraphExtension) (MicrosoftGraphExtension, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/extensions"
...
// GroupsGetExtensionsOpts Optional parameters for the method 'GroupsGetExtensions'
type GroupsGetExtensionsOpts struct {
 ...
 * @param optional nil or *GroupsGetExtensionsOpts - Optional Parameters:
...
@return MicrosoftGraphExtension
*/
func (a *GroupsExtensionApiService) GroupsGetExtensions(ctx _context.Context, groupId string, extensionId string, localVarOptionals *GroupsGetExtensionsOpts) (MicrosoftGraphExtension, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/extensions({extension-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"group-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", groupId)), -1)
...
// GroupsListExtensionsOpts Optional parameters for the method 'GroupsListExtensions'
type GroupsListExtensionsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId key: group-id of group
 * @param optional nil or *GroupsListExtensionsOpts - Optional Parameters:
...
*/
func (a *GroupsExtensionApiService) GroupsListExtensions(ctx _context.Context, groupId string, localVarOptionals *GroupsListExtensionsOpts) (CollectionOfExtension, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsExtensionApiService) GroupsUpdateExtensions(ctx _context.Context, groupId string, extensionId string, microsoftGraphExtension MicrosoftGraphExtension) (*_nethttp.Response, error) {
	var (
