...
// DriveListListItemApiService DriveListListItemApi service
type DriveListListItemApiService service
...
*/
func (a *DriveListListItemApiService) DriveListCreateItems(ctx _context.Context, microsoftGraphListItem MicrosoftGraphListItem) (MicrosoftGraphListItem, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphListItem
*/
func (a *DriveListListItemApiService) DriveListGetItems(ctx _context.Context, listItemId string, localVarOptionals *DriveListGetItemsOpts) (MicrosoftGraphListItem, *_nethttp.Response, error) {
	var (
...
*/
func (a *DriveListListItemApiService) DriveListListItems(ctx _context.Context, localVarOptionals *DriveListListItemsOpts) (CollectionOfListItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DriveListListItemApiService) DriveListUpdateItems(ctx _context.Context, listItemId string, microsoftGraphListItem MicrosoftGraphListItem) (*_nethttp.Response, error) {
	var (
