...
// EducationClassesGroupApiService EducationClassesGroupApi service
type EducationClassesGroupApiService service
...
*/
func (a *EducationClassesGroupApiService) EducationClassesGetGroup(ctx _context.Context, educationClassId string, localVarOptionals *EducationClassesGetGroupOpts) (MicrosoftGraphGroup, *_nethttp.Response, error) {
	var (
