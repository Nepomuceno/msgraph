...
// MicrosoftGraphOmaSettingDateTime struct for MicrosoftGraphOmaSettingDateTime
type MicrosoftGraphOmaSettingDateTime struct {
	// Display Name.
...
func (o MicrosoftGraphOmaSettingDateTime) MarshalJSON() ([]byte, error) {
