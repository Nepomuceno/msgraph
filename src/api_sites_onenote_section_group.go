...
// SitesOnenoteSectionGroupApiService SitesOnenoteSectionGroupApi service
type SitesOnenoteSectionGroupApiService service
...
*/
func (a *SitesOnenoteSectionGroupApiService) SitesOnenoteCreateSectionGroups(ctx _context.Context, siteId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/sectionGroups"
...
// SitesOnenoteGetSectionGroupsOpts Optional parameters for the method 'SitesOnenoteGetSectionGroups'
type SitesOnenoteGetSectionGroupsOpts struct {
 ...
 * @param optional nil or *SitesOnenoteGetSectionGroupsOpts - Optional Parameters:
...
@return MicrosoftGraphSectionGroup
*/
func (a *SitesOnenoteSectionGroupApiService) SitesOnenoteGetSectionGroups(ctx _context.Context, siteId string, sectionGroupId string, localVarOptionals *SitesOnenoteGetSectionGroupsOpts) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/sectionGroups({sectionGroup-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"site-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", siteId)), -1)
...
// SitesOnenoteListSectionGroupsOpts Optional parameters for the method 'SitesOnenoteListSectionGroups'
type SitesOnenoteListSectionGroupsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId key: site-id of site
 * @param optional nil or *SitesOnenoteListSectionGroupsOpts - Optional Parameters:
...
*/
func (a *SitesOnenoteSectionGroupApiService) SitesOnenoteListSectionGroups(ctx _context.Context, siteId string, localVarOptionals *SitesOnenoteListSectionGroupsOpts) (CollectionOfSectionGroup, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SitesOnenoteSectionGroupApiService) SitesOnenoteUpdateSectionGroups(ctx _context.Context, siteId string, sectionGroupId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (*_nethttp.Response, error) {
	var (
