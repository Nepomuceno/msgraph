...
// UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApi service
type UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService) UsersCalendarViewCalendarCreateSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService) UsersCalendarViewCalendarGetSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *UsersCalendarViewCalendarGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService) UsersCalendarViewCalendarListSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, localVarOptionals *UsersCalendarViewCalendarListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersCalendarViewCalendarSingleValueLegacyExtendedPropertyApiService) UsersCalendarViewCalendarUpdateSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
