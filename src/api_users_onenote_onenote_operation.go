...
// UsersOnenoteOnenoteOperationApiService UsersOnenoteOnenoteOperationApi service
type UsersOnenoteOnenoteOperationApiService service
...
*/
func (a *UsersOnenoteOnenoteOperationApiService) UsersOnenoteCreateOperations(ctx _context.Context, userId string, microsoftGraphOnenoteOperation MicrosoftGraphOnenoteOperation) (MicrosoftGraphOnenoteOperation, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphOnenoteOperation
*/
func (a *UsersOnenoteOnenoteOperationApiService) UsersOnenoteGetOperations(ctx _context.Context, userId string, onenoteOperationId string, localVarOptionals *UsersOnenoteGetOperationsOpts) (MicrosoftGraphOnenoteOperation, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteOnenoteOperationApiService) UsersOnenoteListOperations(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListOperationsOpts) (CollectionOfOnenoteOperation, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteOnenoteOperationApiService) UsersOnenoteUpdateOperations(ctx _context.Context, userId string, onenoteOperationId string, microsoftGraphOnenoteOperation MicrosoftGraphOnenoteOperation) (*_nethttp.Response, error) {
	var (
