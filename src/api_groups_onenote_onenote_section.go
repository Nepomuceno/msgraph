...
// GroupsOnenoteOnenoteSectionApiService GroupsOnenoteOnenoteSectionApi service
type GroupsOnenoteOnenoteSectionApiService service
...
*/
func (a *GroupsOnenoteOnenoteSectionApiService) GroupsOnenoteCreateSections(ctx _context.Context, groupId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/sections"
...
// GroupsOnenoteGetSectionsOpts Optional parameters for the method 'GroupsOnenoteGetSections'
type GroupsOnenoteGetSectionsOpts struct {
 ...
 * @param optional nil or *GroupsOnenoteGetSectionsOpts - Optional Parameters:
...
@return MicrosoftGraphOnenoteSection
*/
func (a *GroupsOnenoteOnenoteSectionApiService) GroupsOnenoteGetSections(ctx _context.Context, groupId string, onenoteSectionId string, localVarOptionals *GroupsOnenoteGetSectionsOpts) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/sections({onenoteSection-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"group-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", groupId)), -1)
...
// GroupsOnenoteListSectionsOpts Optional parameters for the method 'GroupsOnenoteListSections'
type GroupsOnenoteListSectionsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId key: group-id of group
 * @param optional nil or *GroupsOnenoteListSectionsOpts - Optional Parameters:
...
*/
func (a *GroupsOnenoteOnenoteSectionApiService) GroupsOnenoteListSections(ctx _context.Context, groupId string, localVarOptionals *GroupsOnenoteListSectionsOpts) (CollectionOfOnenoteSection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsOnenoteOnenoteSectionApiService) GroupsOnenoteUpdateSections(ctx _context.Context, groupId string, onenoteSectionId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (*_nethttp.Response, error) {
	var (
