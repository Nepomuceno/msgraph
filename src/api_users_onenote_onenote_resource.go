...
// UsersOnenoteOnenoteResourceApiService UsersOnenoteOnenoteResourceApi service
type UsersOnenoteOnenoteResourceApiService service
...
*/
func (a *UsersOnenoteOnenoteResourceApiService) UsersOnenoteCreateResources(ctx _context.Context, userId string, microsoftGraphOnenoteResource MicrosoftGraphOnenoteResource) (MicrosoftGraphOnenoteResource, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphOnenoteResource
*/
func (a *UsersOnenoteOnenoteResourceApiService) UsersOnenoteGetResources(ctx _context.Context, userId string, onenoteResourceId string, localVarOptionals *UsersOnenoteGetResourcesOpts) (MicrosoftGraphOnenoteResource, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteOnenoteResourceApiService) UsersOnenoteListResources(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListResourcesOpts) (CollectionOfOnenoteResource, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteOnenoteResourceApiService) UsersOnenoteUpdateResources(ctx _context.Context, userId string, onenoteResourceId string, microsoftGraphOnenoteResource MicrosoftGraphOnenoteResource) (*_nethttp.Response, error) {
	var (
