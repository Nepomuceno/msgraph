...
// MeOnenoteNotebookApiService MeOnenoteNotebookApi service
type MeOnenoteNotebookApiService service
...
*/
func (a *MeOnenoteNotebookApiService) MeOnenoteCreateNotebooks(ctx _context.Context, microsoftGraphNotebook MicrosoftGraphNotebook) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/me/onenote/notebooks"
...
// MeOnenoteGetNotebooksOpts Optional parameters for the method 'MeOnenoteGetNotebooks'
type MeOnenoteGetNotebooksOpts struct {
 ...
 * @param optional nil or *MeOnenoteGetNotebooksOpts - Optional Parameters:
...
@return MicrosoftGraphNotebook
*/
func (a *MeOnenoteNotebookApiService) MeOnenoteGetNotebooks(ctx _context.Context, notebookId string, localVarOptionals *MeOnenoteGetNotebooksOpts) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/onenote/notebooks({notebook-id})"
...
// MeOnenoteListNotebooksOpts Optional parameters for the method 'MeOnenoteListNotebooks'
type MeOnenoteListNotebooksOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MeOnenoteListNotebooksOpts - Optional Parameters:
...
*/
func (a *MeOnenoteNotebookApiService) MeOnenoteListNotebooks(ctx _context.Context, localVarOptionals *MeOnenoteListNotebooksOpts) (CollectionOfNotebook, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeOnenoteNotebookApiService) MeOnenoteUpdateNotebooks(ctx _context.Context, notebookId string, microsoftGraphNotebook MicrosoftGraphNotebook) (*_nethttp.Response, error) {
	var (
