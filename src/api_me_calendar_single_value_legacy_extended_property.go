...
// MeCalendarSingleValueLegacyExtendedPropertyApiService MeCalendarSingleValueLegacyExtendedPropertyApi service
type MeCalendarSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeCalendarSingleValueLegacyExtendedPropertyApiService) MeCalendarCreateSingleValueExtendedProperties(ctx _context.Context, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *MeCalendarSingleValueLegacyExtendedPropertyApiService) MeCalendarGetSingleValueExtendedProperties(ctx _context.Context, singleValueLegacyExtendedPropertyId string, localVarOptionals *MeCalendarGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeCalendarSingleValueLegacyExtendedPropertyApiService) MeCalendarListSingleValueExtendedProperties(ctx _context.Context, localVarOptionals *MeCalendarListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarSingleValueLegacyExtendedPropertyApiService) MeCalendarUpdateSingleValueExtendedProperties(ctx _context.Context, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
