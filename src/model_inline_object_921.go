...
func (o *InlineObject921) GetInumber() AnyOfobject {
...
func (o *InlineObject921) GetInumberOk() (AnyOfobject, bool) {
	if o == nil || o.Inumber == nil {
		var ret AnyOfobject
		return ret, false
	}
...
func (o *InlineObject921) HasInumber() bool {
	if o != nil && o.Inumber != nil {
		return true
	}
...
func (o *InlineObject921) SetInumber(v AnyOfobject) {
	o.Inumber = &v
}
...
func (o *InlineObject921) SetInumberExplicitNull(b bool) {
	o.Inumber = nil
