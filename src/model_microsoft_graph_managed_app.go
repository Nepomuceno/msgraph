...
// MicrosoftGraphManagedApp struct for MicrosoftGraphManagedApp
type MicrosoftGraphManagedApp struct {
...
func (o MicrosoftGraphManagedApp) MarshalJSON() ([]byte, error) {
