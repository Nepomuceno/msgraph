...
func (o *InlineObject519) GetNewReminderTime() MicrosoftGraphDateTimeTimeZone {
...
func (o *InlineObject519) GetNewReminderTimeOk() (MicrosoftGraphDateTimeTimeZone, bool) {
	if o == nil || o.NewReminderTime == nil {
		var ret MicrosoftGraphDateTimeTimeZone
		return ret, false
	}
...
func (o *InlineObject519) HasNewReminderTime() bool {
	if o != nil && o.NewReminderTime != nil {
		return true
	}
...
func (o *InlineObject519) SetNewReminderTime(v MicrosoftGraphDateTimeTimeZone) {
	o.NewReminderTime = &v
}
