...
// MicrosoftGraphOmaSettingString struct for MicrosoftGraphOmaSettingString
type MicrosoftGraphOmaSettingString struct {
	// Display Name.
...
func (o MicrosoftGraphOmaSettingString) MarshalJSON() ([]byte, error) {
