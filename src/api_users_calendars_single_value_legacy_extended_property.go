...
// UsersCalendarsSingleValueLegacyExtendedPropertyApiService UsersCalendarsSingleValueLegacyExtendedPropertyApi service
type UsersCalendarsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *UsersCalendarsSingleValueLegacyExtendedPropertyApiService) UsersCalendarsCreateSingleValueExtendedProperties(ctx _context.Context, userId string, calendarId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersCalendarsSingleValueLegacyExtendedPropertyApiService) UsersCalendarsListSingleValueExtendedProperties(ctx _context.Context, userId string, calendarId string, localVarOptionals *UsersCalendarsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersCalendarsSingleValueLegacyExtendedPropertyApiService) UsersCalendarsUpdateSingleValueExtendedProperties(ctx _context.Context, userId string, calendarId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
