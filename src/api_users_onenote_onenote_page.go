...
// UsersOnenoteOnenotePageApiService UsersOnenoteOnenotePageApi service
type UsersOnenoteOnenotePageApiService service
...
*/
func (a *UsersOnenoteOnenotePageApiService) UsersOnenoteCreatePages(ctx _context.Context, userId string, microsoftGraphOnenotePage MicrosoftGraphOnenotePage) (MicrosoftGraphOnenotePage, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphOnenotePage
*/
func (a *UsersOnenoteOnenotePageApiService) UsersOnenoteGetPages(ctx _context.Context, userId string, onenotePageId string, localVarOptionals *UsersOnenoteGetPagesOpts) (MicrosoftGraphOnenotePage, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteOnenotePageApiService) UsersOnenoteListPages(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListPagesOpts) (CollectionOfOnenotePage, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteOnenotePageApiService) UsersOnenoteUpdatePages(ctx _context.Context, userId string, onenotePageId string, microsoftGraphOnenotePage MicrosoftGraphOnenotePage) (*_nethttp.Response, error) {
	var (
