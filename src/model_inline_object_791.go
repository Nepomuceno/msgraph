...
func (o *InlineObject791) GetX() AnyOfobject {
	if o == nil || o.X == nil {
		var ret AnyOfobject
		return ret
	}
...
func (o *InlineObject791) GetXOk() (AnyOfobject, bool) {
	if o == nil || o.X == nil {
		var ret AnyOfobject
		return ret, false
	}
...
func (o *InlineObject791) HasX() bool {
	if o != nil && o.X != nil {
		return true
	}
...
func (o *InlineObject791) SetX(v AnyOfobject) {
	o.X = &v
}
...
func (o *InlineObject791) SetXExplicitNull(b bool) {
	o.X = nil
	o.isExplicitNullX = b
}
// GetDegFreedom returns the DegFreedom field if non-nil, zero value otherwise.
func (o *InlineObject791) GetDegFreedom() AnyOfobject {
...
// and a boolean to check if the value has been set.
func (o *InlineObject791) GetDegFreedomOk() (AnyOfobject, bool) {
	if o == nil || o.DegFreedom == nil {
		var ret AnyOfobject
		return ret, false
	}
...
func (o *InlineObject791) HasDegFreedom() bool {
	if o != nil && o.DegFreedom != nil {
		return true
	}
...
func (o *InlineObject791) SetDegFreedom(v AnyOfobject) {
	o.DegFreedom = &v
}
...
func (o *InlineObject791) SetDegFreedomExplicitNull(b bool) {
	o.DegFreedom = nil
