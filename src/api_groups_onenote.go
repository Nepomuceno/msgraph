...
// GroupsGetOnenoteOpts Optional parameters for the method 'GroupsGetOnenote'
type GroupsGetOnenoteOpts struct {
 ...
 * @param optional nil or *GroupsGetOnenoteOpts - Optional Parameters:
...
*/
func (a *GroupsOnenoteApiService) GroupsGetOnenote(ctx _context.Context, groupId string, localVarOptionals *GroupsGetOnenoteOpts) (MicrosoftGraphOnenote, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote"
...
*/
func (a *GroupsOnenoteApiService) GroupsUpdateOnenote(ctx _context.Context, groupId string, microsoftGraphOnenote MicrosoftGraphOnenote) (*_nethttp.Response, error) {
	var (
