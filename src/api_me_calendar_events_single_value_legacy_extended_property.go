...
// MeCalendarEventsSingleValueLegacyExtendedPropertyApiService MeCalendarEventsSingleValueLegacyExtendedPropertyApi service
type MeCalendarEventsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeCalendarEventsSingleValueLegacyExtendedPropertyApiService) MeCalendarEventsCreateSingleValueExtendedProperties(ctx _context.Context, eventId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *MeCalendarEventsSingleValueLegacyExtendedPropertyApiService) MeCalendarEventsGetSingleValueExtendedProperties(ctx _context.Context, eventId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *MeCalendarEventsGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeCalendarEventsSingleValueLegacyExtendedPropertyApiService) MeCalendarEventsListSingleValueExtendedProperties(ctx _context.Context, eventId string, localVarOptionals *MeCalendarEventsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarEventsSingleValueLegacyExtendedPropertyApiService) MeCalendarEventsUpdateSingleValueExtendedProperties(ctx _context.Context, eventId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
