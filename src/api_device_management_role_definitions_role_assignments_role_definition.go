...
// DeviceManagementRoleDefinitionsRoleAssignmentsRoleDefinitionApiService DeviceManagementRoleDefinitionsRoleAssignmentsRoleDefinitionApi service
type DeviceManagementRoleDefinitionsRoleAssignmentsRoleDefinitionApiService service
...
func (a *DeviceManagementRoleDefinitionsRoleAssignmentsRoleDefinitionApiService) DeviceManagementRoleDefinitionsRoleAssignmentsGetRoleDefinition(ctx _context.Context, roleDefinitionId string, roleAssignmentId string, localVarOptionals *DeviceManagementRoleDefinitionsRoleAssignmentsGetRoleDefinitionOpts) (MicrosoftGraphRoleDefinition, *_nethttp.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v MicrosoftGraphRoleDefinition
