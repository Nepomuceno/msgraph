...
// SharesGetSiteOpts Optional parameters for the method 'SharesGetSite'
type SharesGetSiteOpts struct {
 ...
 * @param optional nil or *SharesGetSiteOpts - Optional Parameters:
...
*/
func (a *SharesSiteApiService) SharesGetSite(ctx _context.Context, sharedDriveItemId string, localVarOptionals *SharesGetSiteOpts) (MicrosoftGraphSite, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/shares({sharedDriveItem-id})/site"
...
*/
func (a *SharesSiteApiService) SharesUpdateSite(ctx _context.Context, sharedDriveItemId string, microsoftGraphSite MicrosoftGraphSite) (*_nethttp.Response, error) {
	var (
