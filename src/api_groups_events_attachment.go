...
// GroupsEventsAttachmentApiService GroupsEventsAttachmentApi service
type GroupsEventsAttachmentApiService service
...
*/
func (a *GroupsEventsAttachmentApiService) GroupsEventsCreateAttachments(ctx _context.Context, groupId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *GroupsEventsAttachmentApiService) GroupsEventsGetAttachments(ctx _context.Context, groupId string, eventId string, attachmentId string, localVarOptionals *GroupsEventsGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *GroupsEventsAttachmentApiService) GroupsEventsListAttachments(ctx _context.Context, groupId string, eventId string, localVarOptionals *GroupsEventsListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsEventsAttachmentApiService) GroupsEventsUpdateAttachments(ctx _context.Context, groupId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
