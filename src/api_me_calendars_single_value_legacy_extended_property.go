...
// MeCalendarsSingleValueLegacyExtendedPropertyApiService MeCalendarsSingleValueLegacyExtendedPropertyApi service
type MeCalendarsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarsCreateSingleValueExtendedProperties(ctx _context.Context, calendarId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *MeCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarsGetSingleValueExtendedProperties(ctx _context.Context, calendarId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *MeCalendarsGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarsListSingleValueExtendedProperties(ctx _context.Context, calendarId string, localVarOptionals *MeCalendarsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarsUpdateSingleValueExtendedProperties(ctx _context.Context, calendarId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
