...
// GroupsCalendarCalendarViewSingleValueLegacyExtendedPropertyApiService GroupsCalendarCalendarViewSingleValueLegacyExtendedPropertyApi service
type GroupsCalendarCalendarViewSingleValueLegacyExtendedPropertyApiService service
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *GroupsCalendarCalendarViewSingleValueLegacyExtendedPropertyApiService) GroupsCalendarCalendarViewGetSingleValueExtendedProperties(ctx _context.Context, groupId string, eventId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *GroupsCalendarCalendarViewGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *GroupsCalendarCalendarViewSingleValueLegacyExtendedPropertyApiService) GroupsCalendarCalendarViewListSingleValueExtendedProperties(ctx _context.Context, groupId string, eventId string, localVarOptionals *GroupsCalendarCalendarViewListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
