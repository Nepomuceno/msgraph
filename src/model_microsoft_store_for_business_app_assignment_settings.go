...
// MicrosoftStoreForBusinessAppAssignmentSettings struct for MicrosoftStoreForBusinessAppAssignmentSettings
...
func (o MicrosoftStoreForBusinessAppAssignmentSettings) MarshalJSON() ([]byte, error) {
