...
// EducationClassesEducationUserApiService EducationClassesEducationUserApi service
type EducationClassesEducationUserApiService service
...
*/
func (a *EducationClassesEducationUserApiService) EducationClassesGetMembers(ctx _context.Context, educationClassId string, educationUserId string, localVarOptionals *EducationClassesGetMembersOpts) (MicrosoftGraphEducationUser, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"educationUser-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", educationUserId)), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v MicrosoftGraphEducationUser
...
@return MicrosoftGraphEducationUser
*/
func (a *EducationClassesEducationUserApiService) EducationClassesGetTeachers(ctx _context.Context, educationClassId string, educationUserId string, localVarOptionals *EducationClassesGetTeachersOpts) (MicrosoftGraphEducationUser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *EducationClassesEducationUserApiService) EducationClassesListMembers(ctx _context.Context, educationClassId string, localVarOptionals *EducationClassesListMembersOpts) (CollectionOfEducationUser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CollectionOfEducationUser
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
@return CollectionOfEducationUser
*/
func (a *EducationClassesEducationUserApiService) EducationClassesListTeachers(ctx _context.Context, educationClassId string, localVarOptionals *EducationClassesListTeachersOpts) (CollectionOfEducationUser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
