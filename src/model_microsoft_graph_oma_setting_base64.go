...
// MicrosoftGraphOmaSettingBase64 struct for MicrosoftGraphOmaSettingBase64
type MicrosoftGraphOmaSettingBase64 struct {
	// Display Name.
...
func (o MicrosoftGraphOmaSettingBase64) MarshalJSON() ([]byte, error) {
