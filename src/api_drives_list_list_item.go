...
// DrivesListListItemApiService DrivesListListItemApi service
type DrivesListListItemApiService service
...
*/
func (a *DrivesListListItemApiService) DrivesListCreateItems(ctx _context.Context, driveId string, microsoftGraphListItem MicrosoftGraphListItem) (MicrosoftGraphListItem, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphListItem
*/
func (a *DrivesListListItemApiService) DrivesListGetItems(ctx _context.Context, driveId string, listItemId string, localVarOptionals *DrivesListGetItemsOpts) (MicrosoftGraphListItem, *_nethttp.Response, error) {
	var (
...
*/
func (a *DrivesListListItemApiService) DrivesListListItems(ctx _context.Context, driveId string, localVarOptionals *DrivesListListItemsOpts) (CollectionOfListItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DrivesListListItemApiService) DrivesListUpdateItems(ctx _context.Context, driveId string, listItemId string, microsoftGraphListItem MicrosoftGraphListItem) (*_nethttp.Response, error) {
	var (
