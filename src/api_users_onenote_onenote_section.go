...
// UsersOnenoteOnenoteSectionApiService UsersOnenoteOnenoteSectionApi service
type UsersOnenoteOnenoteSectionApiService service
...
*/
func (a *UsersOnenoteOnenoteSectionApiService) UsersOnenoteCreateSections(ctx _context.Context, userId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphOnenoteSection
*/
func (a *UsersOnenoteOnenoteSectionApiService) UsersOnenoteGetSections(ctx _context.Context, userId string, onenoteSectionId string, localVarOptionals *UsersOnenoteGetSectionsOpts) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteOnenoteSectionApiService) UsersOnenoteListSections(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListSectionsOpts) (CollectionOfOnenoteSection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteOnenoteSectionApiService) UsersOnenoteUpdateSections(ctx _context.Context, userId string, onenoteSectionId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (*_nethttp.Response, error) {
	var (
