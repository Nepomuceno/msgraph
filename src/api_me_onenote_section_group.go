...
// MeOnenoteSectionGroupApiService MeOnenoteSectionGroupApi service
type MeOnenoteSectionGroupApiService service
...
*/
func (a *MeOnenoteSectionGroupApiService) MeOnenoteCreateSectionGroups(ctx _context.Context, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/me/onenote/sectionGroups"
...
// MeOnenoteGetSectionGroupsOpts Optional parameters for the method 'MeOnenoteGetSectionGroups'
type MeOnenoteGetSectionGroupsOpts struct {
 ...
 * @param optional nil or *MeOnenoteGetSectionGroupsOpts - Optional Parameters:
...
@return MicrosoftGraphSectionGroup
*/
func (a *MeOnenoteSectionGroupApiService) MeOnenoteGetSectionGroups(ctx _context.Context, sectionGroupId string, localVarOptionals *MeOnenoteGetSectionGroupsOpts) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/onenote/sectionGroups({sectionGroup-id})"
...
// MeOnenoteListSectionGroupsOpts Optional parameters for the method 'MeOnenoteListSectionGroups'
type MeOnenoteListSectionGroupsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MeOnenoteListSectionGroupsOpts - Optional Parameters:
...
*/
func (a *MeOnenoteSectionGroupApiService) MeOnenoteListSectionGroups(ctx _context.Context, localVarOptionals *MeOnenoteListSectionGroupsOpts) (CollectionOfSectionGroup, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeOnenoteSectionGroupApiService) MeOnenoteUpdateSectionGroups(ctx _context.Context, sectionGroupId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (*_nethttp.Response, error) {
	var (
