...
// MicrosoftGraphWindowsInformationProtectionStoreApp struct for MicrosoftGraphWindowsInformationProtectionStoreApp
type MicrosoftGraphWindowsInformationProtectionStoreApp struct {
	// App display name.
...
func (o MicrosoftGraphWindowsInformationProtectionStoreApp) MarshalJSON() ([]byte, error) {
