...
// UsersCalendarEventsSingleValueLegacyExtendedPropertyApiService UsersCalendarEventsSingleValueLegacyExtendedPropertyApi service
type UsersCalendarEventsSingleValueLegacyExtendedPropertyApiService service
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *UsersCalendarEventsSingleValueLegacyExtendedPropertyApiService) UsersCalendarEventsGetSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *UsersCalendarEventsGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersCalendarEventsSingleValueLegacyExtendedPropertyApiService) UsersCalendarEventsListSingleValueExtendedProperties(ctx _context.Context, userId string, eventId string, localVarOptionals *UsersCalendarEventsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
