...
// MicrosoftGraphManagedIosLobApp struct for MicrosoftGraphManagedIosLobApp
type MicrosoftGraphManagedIosLobApp struct {
...
func (o MicrosoftGraphManagedIosLobApp) MarshalJSON() ([]byte, error) {
