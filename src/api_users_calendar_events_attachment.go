...
// UsersCalendarEventsAttachmentApiService UsersCalendarEventsAttachmentApi service
type UsersCalendarEventsAttachmentApiService service
...
*/
func (a *UsersCalendarEventsAttachmentApiService) UsersCalendarEventsCreateAttachments(ctx _context.Context, userId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *UsersCalendarEventsAttachmentApiService) UsersCalendarEventsGetAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, localVarOptionals *UsersCalendarEventsGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersCalendarEventsAttachmentApiService) UsersCalendarEventsListAttachments(ctx _context.Context, userId string, eventId string, localVarOptionals *UsersCalendarEventsListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersCalendarEventsAttachmentApiService) UsersCalendarEventsUpdateAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
