...
// UsersOnenoteNotebookApiService UsersOnenoteNotebookApi service
type UsersOnenoteNotebookApiService service
...
*/
func (a *UsersOnenoteNotebookApiService) UsersOnenoteCreateNotebooks(ctx _context.Context, userId string, microsoftGraphNotebook MicrosoftGraphNotebook) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphNotebook
*/
func (a *UsersOnenoteNotebookApiService) UsersOnenoteGetNotebooks(ctx _context.Context, userId string, notebookId string, localVarOptionals *UsersOnenoteGetNotebooksOpts) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteNotebookApiService) UsersOnenoteListNotebooks(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListNotebooksOpts) (CollectionOfNotebook, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteNotebookApiService) UsersOnenoteUpdateNotebooks(ctx _context.Context, userId string, notebookId string, microsoftGraphNotebook MicrosoftGraphNotebook) (*_nethttp.Response, error) {
	var (
