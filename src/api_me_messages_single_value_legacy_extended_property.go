...
// MeMessagesSingleValueLegacyExtendedPropertyApiService MeMessagesSingleValueLegacyExtendedPropertyApi service
type MeMessagesSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeMessagesSingleValueLegacyExtendedPropertyApiService) MeMessagesCreateSingleValueExtendedProperties(ctx _context.Context, messageId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *MeMessagesSingleValueLegacyExtendedPropertyApiService) MeMessagesGetSingleValueExtendedProperties(ctx _context.Context, messageId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *MeMessagesGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeMessagesSingleValueLegacyExtendedPropertyApiService) MeMessagesListSingleValueExtendedProperties(ctx _context.Context, messageId string, localVarOptionals *MeMessagesListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeMessagesSingleValueLegacyExtendedPropertyApiService) MeMessagesUpdateSingleValueExtendedProperties(ctx _context.Context, messageId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
