...
// UsersOnenoteSectionGroupApiService UsersOnenoteSectionGroupApi service
type UsersOnenoteSectionGroupApiService service
...
*/
func (a *UsersOnenoteSectionGroupApiService) UsersOnenoteCreateSectionGroups(ctx _context.Context, userId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSectionGroup
*/
func (a *UsersOnenoteSectionGroupApiService) UsersOnenoteGetSectionGroups(ctx _context.Context, userId string, sectionGroupId string, localVarOptionals *UsersOnenoteGetSectionGroupsOpts) (MicrosoftGraphSectionGroup, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersOnenoteSectionGroupApiService) UsersOnenoteListSectionGroups(ctx _context.Context, userId string, localVarOptionals *UsersOnenoteListSectionGroupsOpts) (CollectionOfSectionGroup, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersOnenoteSectionGroupApiService) UsersOnenoteUpdateSectionGroups(ctx _context.Context, userId string, sectionGroupId string, microsoftGraphSectionGroup MicrosoftGraphSectionGroup) (*_nethttp.Response, error) {
	var (
