...
// UsersEventsAttachmentApiService UsersEventsAttachmentApi service
type UsersEventsAttachmentApiService service
...
*/
func (a *UsersEventsAttachmentApiService) UsersEventsCreateAttachments(ctx _context.Context, userId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *UsersEventsAttachmentApiService) UsersEventsGetAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, localVarOptionals *UsersEventsGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *UsersEventsAttachmentApiService) UsersEventsListAttachments(ctx _context.Context, userId string, eventId string, localVarOptionals *UsersEventsListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersEventsAttachmentApiService) UsersEventsUpdateAttachments(ctx _context.Context, userId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
