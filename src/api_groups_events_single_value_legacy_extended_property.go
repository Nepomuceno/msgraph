...
// GroupsEventsSingleValueLegacyExtendedPropertyApiService GroupsEventsSingleValueLegacyExtendedPropertyApi service
type GroupsEventsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *GroupsEventsSingleValueLegacyExtendedPropertyApiService) GroupsEventsCreateSingleValueExtendedProperties(ctx _context.Context, groupId string, eventId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *GroupsEventsSingleValueLegacyExtendedPropertyApiService) GroupsEventsGetSingleValueExtendedProperties(ctx _context.Context, groupId string, eventId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *GroupsEventsGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *GroupsEventsSingleValueLegacyExtendedPropertyApiService) GroupsEventsListSingleValueExtendedProperties(ctx _context.Context, groupId string, eventId string, localVarOptionals *GroupsEventsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
