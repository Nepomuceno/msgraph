...
// SharesListContentTypesColumnLinkApiService SharesListContentTypesColumnLinkApi service
type SharesListContentTypesColumnLinkApiService service
...
*/
func (a *SharesListContentTypesColumnLinkApiService) SharesListContentTypesCreateColumnLinks(ctx _context.Context, sharedDriveItemId string, contentTypeId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphColumnLink
*/
func (a *SharesListContentTypesColumnLinkApiService) SharesListContentTypesGetColumnLinks(ctx _context.Context, sharedDriveItemId string, contentTypeId string, columnLinkId string, localVarOptionals *SharesListContentTypesGetColumnLinksOpts) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
*/
func (a *SharesListContentTypesColumnLinkApiService) SharesListContentTypesListColumnLinks(ctx _context.Context, sharedDriveItemId string, contentTypeId string, localVarOptionals *SharesListContentTypesListColumnLinksOpts) (CollectionOfColumnLink, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SharesListContentTypesColumnLinkApiService) SharesListContentTypesUpdateColumnLinks(ctx _context.Context, sharedDriveItemId string, contentTypeId string, columnLinkId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (*_nethttp.Response, error) {
	var (
