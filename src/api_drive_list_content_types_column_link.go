...
// DriveListContentTypesColumnLinkApiService DriveListContentTypesColumnLinkApi service
type DriveListContentTypesColumnLinkApiService service
...
*/
func (a *DriveListContentTypesColumnLinkApiService) DriveListContentTypesCreateColumnLinks(ctx _context.Context, contentTypeId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphColumnLink
*/
func (a *DriveListContentTypesColumnLinkApiService) DriveListContentTypesGetColumnLinks(ctx _context.Context, contentTypeId string, columnLinkId string, localVarOptionals *DriveListContentTypesGetColumnLinksOpts) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
*/
func (a *DriveListContentTypesColumnLinkApiService) DriveListContentTypesListColumnLinks(ctx _context.Context, contentTypeId string, localVarOptionals *DriveListContentTypesListColumnLinksOpts) (CollectionOfColumnLink, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DriveListContentTypesColumnLinkApiService) DriveListContentTypesUpdateColumnLinks(ctx _context.Context, contentTypeId string, columnLinkId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (*_nethttp.Response, error) {
	var (
