...
// MeContactsSingleValueLegacyExtendedPropertyApiService MeContactsSingleValueLegacyExtendedPropertyApi service
type MeContactsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeContactsSingleValueLegacyExtendedPropertyApiService) MeContactsCreateSingleValueExtendedProperties(ctx _context.Context, contactId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphSingleValueLegacyExtendedProperty
*/
func (a *MeContactsSingleValueLegacyExtendedPropertyApiService) MeContactsGetSingleValueExtendedProperties(ctx _context.Context, contactId string, singleValueLegacyExtendedPropertyId string, localVarOptionals *MeContactsGetSingleValueExtendedPropertiesOpts) (MicrosoftGraphSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeContactsSingleValueLegacyExtendedPropertyApiService) MeContactsListSingleValueExtendedProperties(ctx _context.Context, contactId string, localVarOptionals *MeContactsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeContactsSingleValueLegacyExtendedPropertyApiService) MeContactsUpdateSingleValueExtendedProperties(ctx _context.Context, contactId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
