...
// MeCalendarsCalendarViewAttachmentApiService MeCalendarsCalendarViewAttachmentApi service
type MeCalendarsCalendarViewAttachmentApiService service
...
*/
func (a *MeCalendarsCalendarViewAttachmentApiService) MeCalendarsCalendarViewCreateAttachments(ctx _context.Context, calendarId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *MeCalendarsCalendarViewAttachmentApiService) MeCalendarsCalendarViewGetAttachments(ctx _context.Context, calendarId string, eventId string, attachmentId string, localVarOptionals *MeCalendarsCalendarViewGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeCalendarsCalendarViewAttachmentApiService) MeCalendarsCalendarViewListAttachments(ctx _context.Context, calendarId string, eventId string, localVarOptionals *MeCalendarsCalendarViewListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarsCalendarViewAttachmentApiService) MeCalendarsCalendarViewUpdateAttachments(ctx _context.Context, calendarId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
