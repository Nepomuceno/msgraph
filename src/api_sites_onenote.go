...
// SitesGetOnenoteOpts Optional parameters for the method 'SitesGetOnenote'
type SitesGetOnenoteOpts struct {
 ...
 * @param optional nil or *SitesGetOnenoteOpts - Optional Parameters:
...
*/
func (a *SitesOnenoteApiService) SitesGetOnenote(ctx _context.Context, siteId string, localVarOptionals *SitesGetOnenoteOpts) (MicrosoftGraphOnenote, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote"
...
*/
func (a *SitesOnenoteApiService) SitesUpdateOnenote(ctx _context.Context, siteId string, microsoftGraphOnenote MicrosoftGraphOnenote) (*_nethttp.Response, error) {
	var (
