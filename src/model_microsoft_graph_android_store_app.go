...
// MicrosoftGraphAndroidStoreApp struct for MicrosoftGraphAndroidStoreApp
type MicrosoftGraphAndroidStoreApp struct {
...
func (o MicrosoftGraphAndroidStoreApp) MarshalJSON() ([]byte, error) {
