...
// GroupsCalendarViewAttachmentApiService GroupsCalendarViewAttachmentApi service
type GroupsCalendarViewAttachmentApiService service
...
*/
func (a *GroupsCalendarViewAttachmentApiService) GroupsCalendarViewCreateAttachments(ctx _context.Context, groupId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *GroupsCalendarViewAttachmentApiService) GroupsCalendarViewGetAttachments(ctx _context.Context, groupId string, eventId string, attachmentId string, localVarOptionals *GroupsCalendarViewGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *GroupsCalendarViewAttachmentApiService) GroupsCalendarViewListAttachments(ctx _context.Context, groupId string, eventId string, localVarOptionals *GroupsCalendarViewListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsCalendarViewAttachmentApiService) GroupsCalendarViewUpdateAttachments(ctx _context.Context, groupId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
