...
// SitesOnenoteNotebookApiService SitesOnenoteNotebookApi service
type SitesOnenoteNotebookApiService service
...
*/
func (a *SitesOnenoteNotebookApiService) SitesOnenoteCreateNotebooks(ctx _context.Context, siteId string, microsoftGraphNotebook MicrosoftGraphNotebook) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/notebooks"
...
// SitesOnenoteGetNotebooksOpts Optional parameters for the method 'SitesOnenoteGetNotebooks'
type SitesOnenoteGetNotebooksOpts struct {
 ...
 * @param optional nil or *SitesOnenoteGetNotebooksOpts - Optional Parameters:
...
@return MicrosoftGraphNotebook
*/
func (a *SitesOnenoteNotebookApiService) SitesOnenoteGetNotebooks(ctx _context.Context, siteId string, notebookId string, localVarOptionals *SitesOnenoteGetNotebooksOpts) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/notebooks({notebook-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"site-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", siteId)), -1)
...
// SitesOnenoteListNotebooksOpts Optional parameters for the method 'SitesOnenoteListNotebooks'
type SitesOnenoteListNotebooksOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId key: site-id of site
 * @param optional nil or *SitesOnenoteListNotebooksOpts - Optional Parameters:
...
*/
func (a *SitesOnenoteNotebookApiService) SitesOnenoteListNotebooks(ctx _context.Context, siteId string, localVarOptionals *SitesOnenoteListNotebooksOpts) (CollectionOfNotebook, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SitesOnenoteNotebookApiService) SitesOnenoteUpdateNotebooks(ctx _context.Context, siteId string, notebookId string, microsoftGraphNotebook MicrosoftGraphNotebook) (*_nethttp.Response, error) {
	var (
