...
// MeOnenoteOnenotePageApiService MeOnenoteOnenotePageApi service
type MeOnenoteOnenotePageApiService service
...
*/
func (a *MeOnenoteOnenotePageApiService) MeOnenoteCreatePages(ctx _context.Context, microsoftGraphOnenotePage MicrosoftGraphOnenotePage) (MicrosoftGraphOnenotePage, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/me/onenote/pages"
...
// MeOnenoteGetPagesOpts Optional parameters for the method 'MeOnenoteGetPages'
type MeOnenoteGetPagesOpts struct {
 ...
 * @param optional nil or *MeOnenoteGetPagesOpts - Optional Parameters:
...
@return MicrosoftGraphOnenotePage
*/
func (a *MeOnenoteOnenotePageApiService) MeOnenoteGetPages(ctx _context.Context, onenotePageId string, localVarOptionals *MeOnenoteGetPagesOpts) (MicrosoftGraphOnenotePage, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/onenote/pages({onenotePage-id})"
...
// MeOnenoteListPagesOpts Optional parameters for the method 'MeOnenoteListPages'
type MeOnenoteListPagesOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MeOnenoteListPagesOpts - Optional Parameters:
...
*/
func (a *MeOnenoteOnenotePageApiService) MeOnenoteListPages(ctx _context.Context, localVarOptionals *MeOnenoteListPagesOpts) (CollectionOfOnenotePage, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeOnenoteOnenotePageApiService) MeOnenoteUpdatePages(ctx _context.Context, onenotePageId string, microsoftGraphOnenotePage MicrosoftGraphOnenotePage) (*_nethttp.Response, error) {
	var (
