...
// MicrosoftGraphManagedAndroidLobApp struct for MicrosoftGraphManagedAndroidLobApp
type MicrosoftGraphManagedAndroidLobApp struct {
...
func (o MicrosoftGraphManagedAndroidLobApp) MarshalJSON() ([]byte, error) {
