...
// SitesOnenoteOnenoteSectionApiService SitesOnenoteOnenoteSectionApi service
type SitesOnenoteOnenoteSectionApiService service
...
*/
func (a *SitesOnenoteOnenoteSectionApiService) SitesOnenoteCreateSections(ctx _context.Context, siteId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/sections"
...
// SitesOnenoteGetSectionsOpts Optional parameters for the method 'SitesOnenoteGetSections'
type SitesOnenoteGetSectionsOpts struct {
 ...
 * @param optional nil or *SitesOnenoteGetSectionsOpts - Optional Parameters:
...
@return MicrosoftGraphOnenoteSection
*/
func (a *SitesOnenoteOnenoteSectionApiService) SitesOnenoteGetSections(ctx _context.Context, siteId string, onenoteSectionId string, localVarOptionals *SitesOnenoteGetSectionsOpts) (MicrosoftGraphOnenoteSection, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sites({site-id})/onenote/sections({onenoteSection-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"site-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", siteId)), -1)
...
// SitesOnenoteListSectionsOpts Optional parameters for the method 'SitesOnenoteListSections'
type SitesOnenoteListSectionsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId key: site-id of site
 * @param optional nil or *SitesOnenoteListSectionsOpts - Optional Parameters:
...
*/
func (a *SitesOnenoteOnenoteSectionApiService) SitesOnenoteListSections(ctx _context.Context, siteId string, localVarOptionals *SitesOnenoteListSectionsOpts) (CollectionOfOnenoteSection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SitesOnenoteOnenoteSectionApiService) SitesOnenoteUpdateSections(ctx _context.Context, siteId string, onenoteSectionId string, microsoftGraphOnenoteSection MicrosoftGraphOnenoteSection) (*_nethttp.Response, error) {
	var (
