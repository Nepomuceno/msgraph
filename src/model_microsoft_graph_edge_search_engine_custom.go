...
// MicrosoftGraphEdgeSearchEngineCustom struct for MicrosoftGraphEdgeSearchEngineCustom
type MicrosoftGraphEdgeSearchEngineCustom struct {
...
func (o MicrosoftGraphEdgeSearchEngineCustom) MarshalJSON() ([]byte, error) {
