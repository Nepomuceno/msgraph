...
// MeCalendarsEventsAttachmentApiService MeCalendarsEventsAttachmentApi service
type MeCalendarsEventsAttachmentApiService service
...
*/
func (a *MeCalendarsEventsAttachmentApiService) MeCalendarsEventsCreateAttachments(ctx _context.Context, calendarId string, eventId string, microsoftGraphAttachment MicrosoftGraphAttachment) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphAttachment
*/
func (a *MeCalendarsEventsAttachmentApiService) MeCalendarsEventsGetAttachments(ctx _context.Context, calendarId string, eventId string, attachmentId string, localVarOptionals *MeCalendarsEventsGetAttachmentsOpts) (MicrosoftGraphAttachment, *_nethttp.Response, error) {
	var (
...
*/
func (a *MeCalendarsEventsAttachmentApiService) MeCalendarsEventsListAttachments(ctx _context.Context, calendarId string, eventId string, localVarOptionals *MeCalendarsEventsListAttachmentsOpts) (CollectionOfAttachment, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarsEventsAttachmentApiService) MeCalendarsEventsUpdateAttachments(ctx _context.Context, calendarId string, eventId string, attachmentId string, microsoftGraphAttachment MicrosoftGraphAttachment) (*_nethttp.Response, error) {
	var (
