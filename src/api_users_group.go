...
// UsersGroupApiService UsersGroupApi service
type UsersGroupApiService service
...
*/
func (a *UsersGroupApiService) UsersCreateJoinedTeams(ctx _context.Context, userId string, microsoftGraphGroup MicrosoftGraphGroup) (MicrosoftGraphGroup, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users({user-id})/joinedTeams"
...
// UsersGetJoinedTeamsOpts Optional parameters for the method 'UsersGetJoinedTeams'
type UsersGetJoinedTeamsOpts struct {
 ...
 * @param optional nil or *UsersGetJoinedTeamsOpts - Optional Parameters:
...
@return MicrosoftGraphGroup
*/
func (a *UsersGroupApiService) UsersGetJoinedTeams(ctx _context.Context, userId string, groupId string, localVarOptionals *UsersGetJoinedTeamsOpts) (MicrosoftGraphGroup, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users({user-id})/joinedTeams({group-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"user-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", userId)), -1)
...
// UsersListJoinedTeamsOpts Optional parameters for the method 'UsersListJoinedTeams'
type UsersListJoinedTeamsOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId key: user-id of user
 * @param optional nil or *UsersListJoinedTeamsOpts - Optional Parameters:
...
*/
func (a *UsersGroupApiService) UsersListJoinedTeams(ctx _context.Context, userId string, localVarOptionals *UsersListJoinedTeamsOpts) (CollectionOfGroup, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersGroupApiService) UsersUpdateJoinedTeams(ctx _context.Context, userId string, groupId string, microsoftGraphGroup MicrosoftGraphGroup) (*_nethttp.Response, error) {
	var (
