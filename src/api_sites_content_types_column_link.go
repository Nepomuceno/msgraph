...
// SitesContentTypesColumnLinkApiService SitesContentTypesColumnLinkApi service
type SitesContentTypesColumnLinkApiService service
...
*/
func (a *SitesContentTypesColumnLinkApiService) SitesContentTypesCreateColumnLinks(ctx _context.Context, siteId string, contentTypeId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
@return MicrosoftGraphColumnLink
*/
func (a *SitesContentTypesColumnLinkApiService) SitesContentTypesGetColumnLinks(ctx _context.Context, siteId string, contentTypeId string, columnLinkId string, localVarOptionals *SitesContentTypesGetColumnLinksOpts) (MicrosoftGraphColumnLink, *_nethttp.Response, error) {
	var (
...
*/
func (a *SitesContentTypesColumnLinkApiService) SitesContentTypesListColumnLinks(ctx _context.Context, siteId string, contentTypeId string, localVarOptionals *SitesContentTypesListColumnLinksOpts) (CollectionOfColumnLink, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *SitesContentTypesColumnLinkApiService) SitesContentTypesUpdateColumnLinks(ctx _context.Context, siteId string, contentTypeId string, columnLinkId string, microsoftGraphColumnLink MicrosoftGraphColumnLink) (*_nethttp.Response, error) {
	var (
