...
// MeCalendarGroupsCalendarsSingleValueLegacyExtendedPropertyApiService MeCalendarGroupsCalendarsSingleValueLegacyExtendedPropertyApi service
type MeCalendarGroupsCalendarsSingleValueLegacyExtendedPropertyApiService service
...
*/
func (a *MeCalendarGroupsCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarGroupsCalendarsListSingleValueExtendedProperties(ctx _context.Context, calendarGroupId string, calendarId string, localVarOptionals *MeCalendarGroupsCalendarsListSingleValueExtendedPropertiesOpts) (CollectionOfSingleValueLegacyExtendedProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *MeCalendarGroupsCalendarsSingleValueLegacyExtendedPropertyApiService) MeCalendarGroupsCalendarsUpdateSingleValueExtendedProperties(ctx _context.Context, calendarGroupId string, calendarId string, singleValueLegacyExtendedPropertyId string, microsoftGraphSingleValueLegacyExtendedProperty MicrosoftGraphSingleValueLegacyExtendedProperty) (*_nethttp.Response, error) {
	var (
