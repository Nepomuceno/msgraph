...
// GroupsOnenoteNotebookApiService GroupsOnenoteNotebookApi service
type GroupsOnenoteNotebookApiService service
...
*/
func (a *GroupsOnenoteNotebookApiService) GroupsOnenoteCreateNotebooks(ctx _context.Context, groupId string, microsoftGraphNotebook MicrosoftGraphNotebook) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/notebooks"
...
// GroupsOnenoteGetNotebooksOpts Optional parameters for the method 'GroupsOnenoteGetNotebooks'
type GroupsOnenoteGetNotebooksOpts struct {
 ...
 * @param optional nil or *GroupsOnenoteGetNotebooksOpts - Optional Parameters:
...
@return MicrosoftGraphNotebook
*/
func (a *GroupsOnenoteNotebookApiService) GroupsOnenoteGetNotebooks(ctx _context.Context, groupId string, notebookId string, localVarOptionals *GroupsOnenoteGetNotebooksOpts) (MicrosoftGraphNotebook, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups({group-id})/onenote/notebooks({notebook-id})"
	localVarPath = strings.Replace(localVarPath, "{"+"group-id"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", groupId)), -1)
...
// GroupsOnenoteListNotebooksOpts Optional parameters for the method 'GroupsOnenoteListNotebooks'
type GroupsOnenoteListNotebooksOpts struct {
    Top optional.Int32
    Skip optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId key: group-id of group
 * @param optional nil or *GroupsOnenoteListNotebooksOpts - Optional Parameters:
...
*/
func (a *GroupsOnenoteNotebookApiService) GroupsOnenoteListNotebooks(ctx _context.Context, groupId string, localVarOptionals *GroupsOnenoteListNotebooksOpts) (CollectionOfNotebook, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *GroupsOnenoteNotebookApiService) GroupsOnenoteUpdateNotebooks(ctx _context.Context, groupId string, notebookId string, microsoftGraphNotebook MicrosoftGraphNotebook) (*_nethttp.Response, error) {
	var (
