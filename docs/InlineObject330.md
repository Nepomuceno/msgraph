...
`func (o *InlineObject330) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *InlineObject330) GetIdOk() (string, bool)`
...
`func (o *InlineObject330) HasId() bool`

HasId returns a boolean if a field has been set.

### SetId

`func (o *InlineObject330) SetId(v string)`

SetId gets a reference to the given string and assigns it to the Id field.

### SetIdExplicitNull

`func (o *InlineObject330) SetIdExplicitNull(b bool)`
...
`func (o *InlineObject330) SetGroupIdExplicitNull(b bool)`
...
`func (o *InlineObject330) SetSiteCollectionIdExplicitNull(b bool)`
...
`func (o *InlineObject330) SetSiteIdExplicitNull(b bool)`
