# \MeCalendarEventsSingleValueLegacyExtendedPropertyApi

All URIs are relative to *https://graph.microsoft.com/v1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**MeCalendarEventsCreateSingleValueExtendedProperties**](MeCalendarEventsSingleValueLegacyExtendedPropertyApi.md#MeCalendarEventsCreateSingleValueExtendedProperties) | **Post** /me/calendar/events({event-id})/singleValueExtendedProperties | Create new navigation property to singleValueExtendedProperties for me
[**MeCalendarEventsGetSingleValueExtendedProperties**](MeCalendarEventsSingleValueLegacyExtendedPropertyApi.md#MeCalendarEventsGetSingleValueExtendedProperties) | **Get** /me/calendar/events({event-id})/singleValueExtendedProperties({singleValueLegacyExtendedProperty-id}) | Get singleValueExtendedProperties from me
[**MeCalendarEventsListSingleValueExtendedProperties**](MeCalendarEventsSingleValueLegacyExtendedPropertyApi.md#MeCalendarEventsListSingleValueExtendedProperties) | **Get** /me/calendar/events({event-id})/singleValueExtendedProperties | Get singleValueExtendedProperties from me
[**MeCalendarEventsUpdateSingleValueExtendedProperties**](MeCalendarEventsSingleValueLegacyExtendedPropertyApi.md#MeCalendarEventsUpdateSingleValueExtendedProperties) | **Patch** /me/calendar/events({event-id})/singleValueExtendedProperties({singleValueLegacyExtendedProperty-id}) | Update the navigation property singleValueExtendedProperties in me
