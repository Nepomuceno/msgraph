...
`func (o *InlineObject889) GetX() AnyOfobject`

GetX returns the X field if non-nil, zero value otherwise.

### GetXOk

`func (o *InlineObject889) GetXOk() (AnyOfobject, bool)`
...
`func (o *InlineObject889) HasX() bool`

HasX returns a boolean if a field has been set.

### SetX

`func (o *InlineObject889) SetX(v AnyOfobject)`

SetX gets a reference to the given AnyOfobject and assigns it to the X field.

### SetXExplicitNull

`func (o *InlineObject889) SetXExplicitNull(b bool)`
