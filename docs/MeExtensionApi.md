...
> MicrosoftGraphExtension MeCreateExtensions(ctx, microsoftGraphExtension)
...
> MicrosoftGraphExtension MeGetExtensions(ctx, extensionId, optional)
 ...
 **optional** | ***MeGetExtensionsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a MeGetExtensionsOpts struct
...
> CollectionOfExtension MeListExtensions(ctx, optional)
Get extensions from me
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***MeListExtensionsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a MeListExtensionsOpts struct
...
> MeUpdateExtensions(ctx, extensionId, microsoftGraphExtension)
