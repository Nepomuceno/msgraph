# \UsersMessagesAttachmentApi

All URIs are relative to *https://graph.microsoft.com/v1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**UsersMessagesCreateAttachments**](UsersMessagesAttachmentApi.md#UsersMessagesCreateAttachments) | **Post** /users({user-id})/messages({message-id})/attachments | Create new navigation property to attachments for users
[**UsersMessagesGetAttachments**](UsersMessagesAttachmentApi.md#UsersMessagesGetAttachments) | **Get** /users({user-id})/messages({message-id})/attachments({attachment-id}) | Get attachments from users
[**UsersMessagesListAttachments**](UsersMessagesAttachmentApi.md#UsersMessagesListAttachments) | **Get** /users({user-id})/messages({message-id})/attachments | Get attachments from users
[**UsersMessagesUpdateAttachments**](UsersMessagesAttachmentApi.md#UsersMessagesUpdateAttachments) | **Patch** /users({user-id})/messages({message-id})/attachments({attachment-id}) | Update the navigation property attachments in users
