...
`func (o *InlineObject951) GetText() AnyOfobject`

GetText returns the Text field if non-nil, zero value otherwise.

### GetTextOk

`func (o *InlineObject951) GetTextOk() (AnyOfobject, bool)`
...
`func (o *InlineObject951) HasText() bool`

HasText returns a boolean if a field has been set.

### SetText

`func (o *InlineObject951) SetText(v AnyOfobject)`

SetText gets a reference to the given AnyOfobject and assigns it to the Text field.

### SetTextExplicitNull

`func (o *InlineObject951) SetTextExplicitNull(b bool)`
