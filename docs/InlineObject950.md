...
`func (o *InlineObject950) GetText() AnyOfobject`

GetText returns the Text field if non-nil, zero value otherwise.

### GetTextOk

`func (o *InlineObject950) GetTextOk() (AnyOfobject, bool)`
...
`func (o *InlineObject950) HasText() bool`

HasText returns a boolean if a field has been set.

### SetText

`func (o *InlineObject950) SetText(v AnyOfobject)`

SetText gets a reference to the given AnyOfobject and assigns it to the Text field.

### SetTextExplicitNull

`func (o *InlineObject950) SetTextExplicitNull(b bool)`
