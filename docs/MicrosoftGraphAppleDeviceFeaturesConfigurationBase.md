...
`func (o *MicrosoftGraphAppleDeviceFeaturesConfigurationBase) SetId(v string)`
...
`func (o *MicrosoftGraphAppleDeviceFeaturesConfigurationBase) SetDisplayName(v string)`
