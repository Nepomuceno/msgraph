...
`func (o *InlineObject1080) GetText() AnyOfobject`

GetText returns the Text field if non-nil, zero value otherwise.

### GetTextOk

`func (o *InlineObject1080) GetTextOk() (AnyOfobject, bool)`
...
`func (o *InlineObject1080) HasText() bool`

HasText returns a boolean if a field has been set.

### SetText

`func (o *InlineObject1080) SetText(v AnyOfobject)`

SetText gets a reference to the given AnyOfobject and assigns it to the Text field.

### SetTextExplicitNull

`func (o *InlineObject1080) SetTextExplicitNull(b bool)`
