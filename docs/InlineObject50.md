...
`func (o *InlineObject50) GetSchedules() []string`

GetSchedules returns the Schedules field if non-nil, zero value otherwise.

### GetSchedulesOk

`func (o *InlineObject50) GetSchedulesOk() ([]string, bool)`
...
`func (o *InlineObject50) HasSchedules() bool`

HasSchedules returns a boolean if a field has been set.

### SetSchedules

`func (o *InlineObject50) SetSchedules(v []string)`

SetSchedules gets a reference to the given []string and assigns it to the Schedules field.

### GetEndTime

`func (o *InlineObject50) GetEndTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetEndTime returns the EndTime field if non-nil, zero value otherwise.

### GetEndTimeOk

`func (o *InlineObject50) GetEndTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject50) HasEndTime() bool`

HasEndTime returns a boolean if a field has been set.

### SetEndTime

`func (o *InlineObject50) SetEndTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject50) SetEndTimeExplicitNull(b bool)`
...
`func (o *InlineObject50) GetStartTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetStartTime returns the StartTime field if non-nil, zero value otherwise.

### GetStartTimeOk

`func (o *InlineObject50) GetStartTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject50) HasStartTime() bool`

HasStartTime returns a boolean if a field has been set.

### SetStartTime

`func (o *InlineObject50) SetStartTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject50) SetStartTimeExplicitNull(b bool)`
...
`func (o *InlineObject50) GetAvailabilityViewInterval() int32`
...
`func (o *InlineObject50) GetAvailabilityViewIntervalOk() (int32, bool)`
...
`func (o *InlineObject50) HasAvailabilityViewInterval() bool`

HasAvailabilityViewInterval returns a boolean if a field has been set.

### SetAvailabilityViewInterval

`func (o *InlineObject50) SetAvailabilityViewInterval(v int32)`
...
`func (o *InlineObject50) SetAvailabilityViewIntervalExplicitNull(b bool)`
