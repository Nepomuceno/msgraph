...
`func (o *InlineObject523) GetNewReminderTime() MicrosoftGraphDateTimeTimeZone`

GetNewReminderTime returns the NewReminderTime field if non-nil, zero value otherwise.

### GetNewReminderTimeOk

`func (o *InlineObject523) GetNewReminderTimeOk() (MicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject523) HasNewReminderTime() bool`

HasNewReminderTime returns a boolean if a field has been set.

### SetNewReminderTime

`func (o *InlineObject523) SetNewReminderTime(v MicrosoftGraphDateTimeTimeZone)`
