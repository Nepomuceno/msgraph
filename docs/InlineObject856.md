...
`func (o *InlineObject856) GetNumber() AnyOfobject`

GetNumber returns the Number field if non-nil, zero value otherwise.

### GetNumberOk

`func (o *InlineObject856) GetNumberOk() (AnyOfobject, bool)`
...
`func (o *InlineObject856) HasNumber() bool`

HasNumber returns a boolean if a field has been set.

### SetNumber

`func (o *InlineObject856) SetNumber(v AnyOfobject)`

SetNumber gets a reference to the given AnyOfobject and assigns it to the Number field.

### SetNumberExplicitNull

`func (o *InlineObject856) SetNumberExplicitNull(b bool)`
...
`func (o *InlineObject856) GetSignificance() AnyOfobject`

GetSignificance returns the Significance field if non-nil, zero value otherwise.

### GetSignificanceOk

`func (o *InlineObject856) GetSignificanceOk() (AnyOfobject, bool)`
...
`func (o *InlineObject856) HasSignificance() bool`

HasSignificance returns a boolean if a field has been set.

### SetSignificance

`func (o *InlineObject856) SetSignificance(v AnyOfobject)`
...
`func (o *InlineObject856) SetSignificanceExplicitNull(b bool)`
