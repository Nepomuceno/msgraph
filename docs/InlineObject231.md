...
`func (o *InlineObject231) GetSchedules() []string`

GetSchedules returns the Schedules field if non-nil, zero value otherwise.

### GetSchedulesOk

`func (o *InlineObject231) GetSchedulesOk() ([]string, bool)`
...
`func (o *InlineObject231) HasSchedules() bool`

HasSchedules returns a boolean if a field has been set.

### SetSchedules

`func (o *InlineObject231) SetSchedules(v []string)`

SetSchedules gets a reference to the given []string and assigns it to the Schedules field.

### GetEndTime

`func (o *InlineObject231) GetEndTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetEndTime returns the EndTime field if non-nil, zero value otherwise.

### GetEndTimeOk

`func (o *InlineObject231) GetEndTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject231) HasEndTime() bool`

HasEndTime returns a boolean if a field has been set.

### SetEndTime

`func (o *InlineObject231) SetEndTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject231) SetEndTimeExplicitNull(b bool)`
...
`func (o *InlineObject231) GetStartTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetStartTime returns the StartTime field if non-nil, zero value otherwise.

### GetStartTimeOk

`func (o *InlineObject231) GetStartTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject231) HasStartTime() bool`

HasStartTime returns a boolean if a field has been set.

### SetStartTime

`func (o *InlineObject231) SetStartTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject231) SetStartTimeExplicitNull(b bool)`
...
`func (o *InlineObject231) GetAvailabilityViewInterval() int32`
...
`func (o *InlineObject231) GetAvailabilityViewIntervalOk() (int32, bool)`
...
`func (o *InlineObject231) HasAvailabilityViewInterval() bool`

HasAvailabilityViewInterval returns a boolean if a field has been set.

### SetAvailabilityViewInterval

`func (o *InlineObject231) SetAvailabilityViewInterval(v int32)`
...
`func (o *InlineObject231) SetAvailabilityViewIntervalExplicitNull(b bool)`
