...
`func (o *InlineObject654) SetGroupIdExplicitNull(b bool)`
...
`func (o *InlineObject654) GetRenameAs() string`

GetRenameAs returns the RenameAs field if non-nil, zero value otherwise.

### GetRenameAsOk

`func (o *InlineObject654) GetRenameAsOk() (string, bool)`
...
`func (o *InlineObject654) HasRenameAs() bool`

HasRenameAs returns a boolean if a field has been set.

### SetRenameAs

`func (o *InlineObject654) SetRenameAs(v string)`

SetRenameAs gets a reference to the given string and assigns it to the RenameAs field.

### SetRenameAsExplicitNull

`func (o *InlineObject654) SetRenameAsExplicitNull(b bool)`
...
`func (o *InlineObject654) GetNotebookFolder() string`

GetNotebookFolder returns the NotebookFolder field if non-nil, zero value otherwise.

### GetNotebookFolderOk

`func (o *InlineObject654) GetNotebookFolderOk() (string, bool)`
...
`func (o *InlineObject654) HasNotebookFolder() bool`

HasNotebookFolder returns a boolean if a field has been set.

### SetNotebookFolder

`func (o *InlineObject654) SetNotebookFolder(v string)`
...
`func (o *InlineObject654) SetNotebookFolderExplicitNull(b bool)`
...
`func (o *InlineObject654) SetSiteCollectionIdExplicitNull(b bool)`
...
`func (o *InlineObject654) SetSiteIdExplicitNull(b bool)`
