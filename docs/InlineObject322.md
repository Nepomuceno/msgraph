...
`func (o *InlineObject322) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *InlineObject322) GetIdOk() (string, bool)`
...
`func (o *InlineObject322) HasId() bool`

HasId returns a boolean if a field has been set.

### SetId

`func (o *InlineObject322) SetId(v string)`

SetId gets a reference to the given string and assigns it to the Id field.

### SetIdExplicitNull

`func (o *InlineObject322) SetIdExplicitNull(b bool)`
...
`func (o *InlineObject322) SetGroupIdExplicitNull(b bool)`
...
`func (o *InlineObject322) SetSiteCollectionIdExplicitNull(b bool)`
...
`func (o *InlineObject322) SetSiteIdExplicitNull(b bool)`
