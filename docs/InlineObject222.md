...
`func (o *InlineObject222) GetSchedules() []string`

GetSchedules returns the Schedules field if non-nil, zero value otherwise.

### GetSchedulesOk

`func (o *InlineObject222) GetSchedulesOk() ([]string, bool)`
...
`func (o *InlineObject222) HasSchedules() bool`

HasSchedules returns a boolean if a field has been set.

### SetSchedules

`func (o *InlineObject222) SetSchedules(v []string)`

SetSchedules gets a reference to the given []string and assigns it to the Schedules field.

### GetEndTime

`func (o *InlineObject222) GetEndTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetEndTime returns the EndTime field if non-nil, zero value otherwise.

### GetEndTimeOk

`func (o *InlineObject222) GetEndTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject222) HasEndTime() bool`

HasEndTime returns a boolean if a field has been set.

### SetEndTime

`func (o *InlineObject222) SetEndTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject222) SetEndTimeExplicitNull(b bool)`
...
`func (o *InlineObject222) GetStartTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetStartTime returns the StartTime field if non-nil, zero value otherwise.

### GetStartTimeOk

`func (o *InlineObject222) GetStartTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject222) HasStartTime() bool`

HasStartTime returns a boolean if a field has been set.

### SetStartTime

`func (o *InlineObject222) SetStartTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject222) SetStartTimeExplicitNull(b bool)`
...
`func (o *InlineObject222) GetAvailabilityViewInterval() int32`
...
`func (o *InlineObject222) GetAvailabilityViewIntervalOk() (int32, bool)`
...
`func (o *InlineObject222) HasAvailabilityViewInterval() bool`

HasAvailabilityViewInterval returns a boolean if a field has been set.

### SetAvailabilityViewInterval

`func (o *InlineObject222) SetAvailabilityViewInterval(v int32)`
...
`func (o *InlineObject222) SetAvailabilityViewIntervalExplicitNull(b bool)`
