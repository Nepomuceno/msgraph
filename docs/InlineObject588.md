...
`func (o *InlineObject588) GetNewReminderTime() MicrosoftGraphDateTimeTimeZone`

GetNewReminderTime returns the NewReminderTime field if non-nil, zero value otherwise.

### GetNewReminderTimeOk

`func (o *InlineObject588) GetNewReminderTimeOk() (MicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject588) HasNewReminderTime() bool`

HasNewReminderTime returns a boolean if a field has been set.

### SetNewReminderTime

`func (o *InlineObject588) SetNewReminderTime(v MicrosoftGraphDateTimeTimeZone)`
