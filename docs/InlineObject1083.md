...
`func (o *InlineObject1083) GetText() AnyOfobject`

GetText returns the Text field if non-nil, zero value otherwise.

### GetTextOk

`func (o *InlineObject1083) GetTextOk() (AnyOfobject, bool)`
...
`func (o *InlineObject1083) HasText() bool`

HasText returns a boolean if a field has been set.

### SetText

`func (o *InlineObject1083) SetText(v AnyOfobject)`

SetText gets a reference to the given AnyOfobject and assigns it to the Text field.

### SetTextExplicitNull

`func (o *InlineObject1083) SetTextExplicitNull(b bool)`
