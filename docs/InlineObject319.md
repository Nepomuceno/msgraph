...
`func (o *InlineObject319) SetGroupIdExplicitNull(b bool)`
...
`func (o *InlineObject319) GetRenameAs() string`

GetRenameAs returns the RenameAs field if non-nil, zero value otherwise.

### GetRenameAsOk

`func (o *InlineObject319) GetRenameAsOk() (string, bool)`
...
`func (o *InlineObject319) HasRenameAs() bool`

HasRenameAs returns a boolean if a field has been set.

### SetRenameAs

`func (o *InlineObject319) SetRenameAs(v string)`

SetRenameAs gets a reference to the given string and assigns it to the RenameAs field.

### SetRenameAsExplicitNull

`func (o *InlineObject319) SetRenameAsExplicitNull(b bool)`
...
`func (o *InlineObject319) GetNotebookFolder() string`

GetNotebookFolder returns the NotebookFolder field if non-nil, zero value otherwise.

### GetNotebookFolderOk

`func (o *InlineObject319) GetNotebookFolderOk() (string, bool)`
...
`func (o *InlineObject319) HasNotebookFolder() bool`

HasNotebookFolder returns a boolean if a field has been set.

### SetNotebookFolder

`func (o *InlineObject319) SetNotebookFolder(v string)`
...
`func (o *InlineObject319) SetNotebookFolderExplicitNull(b bool)`
...
`func (o *InlineObject319) SetSiteCollectionIdExplicitNull(b bool)`
...
`func (o *InlineObject319) SetSiteIdExplicitNull(b bool)`
