# \GroupsCalendarEventApi

All URIs are relative to *https://graph.microsoft.com/v1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GroupsCalendarCreateCalendarView**](GroupsCalendarEventApi.md#GroupsCalendarCreateCalendarView) | **Post** /groups({group-id})/calendar/calendarView | Create new navigation property to calendarView for groups
[**GroupsCalendarCreateEvents**](GroupsCalendarEventApi.md#GroupsCalendarCreateEvents) | **Post** /groups({group-id})/calendar/events | Create new navigation property to events for groups
[**GroupsCalendarGetCalendarView**](GroupsCalendarEventApi.md#GroupsCalendarGetCalendarView) | **Get** /groups({group-id})/calendar/calendarView({event-id}) | Get calendarView from groups
[**GroupsCalendarGetEvents**](GroupsCalendarEventApi.md#GroupsCalendarGetEvents) | **Get** /groups({group-id})/calendar/events({event-id}) | Get events from groups
[**GroupsCalendarListCalendarView**](GroupsCalendarEventApi.md#GroupsCalendarListCalendarView) | **Get** /groups({group-id})/calendar/calendarView | Get calendarView from groups
[**GroupsCalendarListEvents**](GroupsCalendarEventApi.md#GroupsCalendarListEvents) | **Get** /groups({group-id})/calendar/events | Get events from groups
[**GroupsCalendarUpdateCalendarView**](GroupsCalendarEventApi.md#GroupsCalendarUpdateCalendarView) | **Patch** /groups({group-id})/calendar/calendarView({event-id}) | Update the navigation property calendarView in groups
[**GroupsCalendarUpdateEvents**](GroupsCalendarEventApi.md#GroupsCalendarUpdateEvents) | **Patch** /groups({group-id})/calendar/events({event-id}) | Update the navigation property events in groups
