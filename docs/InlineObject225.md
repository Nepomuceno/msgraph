...
`func (o *InlineObject225) GetNewReminderTime() MicrosoftGraphDateTimeTimeZone`

GetNewReminderTime returns the NewReminderTime field if non-nil, zero value otherwise.

### GetNewReminderTimeOk

`func (o *InlineObject225) GetNewReminderTimeOk() (MicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject225) HasNewReminderTime() bool`

HasNewReminderTime returns a boolean if a field has been set.

### SetNewReminderTime

`func (o *InlineObject225) SetNewReminderTime(v MicrosoftGraphDateTimeTimeZone)`
