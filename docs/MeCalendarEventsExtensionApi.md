# \MeCalendarEventsExtensionApi

All URIs are relative to *https://graph.microsoft.com/v1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**MeCalendarEventsCreateExtensions**](MeCalendarEventsExtensionApi.md#MeCalendarEventsCreateExtensions) | **Post** /me/calendar/events({event-id})/extensions | Create new navigation property to extensions for me
[**MeCalendarEventsGetExtensions**](MeCalendarEventsExtensionApi.md#MeCalendarEventsGetExtensions) | **Get** /me/calendar/events({event-id})/extensions({extension-id}) | Get extensions from me
[**MeCalendarEventsListExtensions**](MeCalendarEventsExtensionApi.md#MeCalendarEventsListExtensions) | **Get** /me/calendar/events({event-id})/extensions | Get extensions from me
[**MeCalendarEventsUpdateExtensions**](MeCalendarEventsExtensionApi.md#MeCalendarEventsUpdateExtensions) | **Patch** /me/calendar/events({event-id})/extensions({extension-id}) | Update the navigation property extensions in me
...
> MicrosoftGraphExtension MeCalendarEventsGetExtensions(ctx, eventId, extensionId, optional)
