...
`func (o *InlineObject795) GetText() AnyOfobject`

GetText returns the Text field if non-nil, zero value otherwise.

### GetTextOk

`func (o *InlineObject795) GetTextOk() (AnyOfobject, bool)`
...
`func (o *InlineObject795) HasText() bool`

HasText returns a boolean if a field has been set.

### SetText

`func (o *InlineObject795) SetText(v AnyOfobject)`

SetText gets a reference to the given AnyOfobject and assigns it to the Text field.

### SetTextExplicitNull

`func (o *InlineObject795) SetTextExplicitNull(b bool)`
