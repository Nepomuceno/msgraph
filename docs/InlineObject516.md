...
`func (o *InlineObject516) GetSchedules() []string`

GetSchedules returns the Schedules field if non-nil, zero value otherwise.

### GetSchedulesOk

`func (o *InlineObject516) GetSchedulesOk() ([]string, bool)`
...
`func (o *InlineObject516) HasSchedules() bool`

HasSchedules returns a boolean if a field has been set.

### SetSchedules

`func (o *InlineObject516) SetSchedules(v []string)`

SetSchedules gets a reference to the given []string and assigns it to the Schedules field.

### GetEndTime

`func (o *InlineObject516) GetEndTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetEndTime returns the EndTime field if non-nil, zero value otherwise.

### GetEndTimeOk

`func (o *InlineObject516) GetEndTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject516) HasEndTime() bool`

HasEndTime returns a boolean if a field has been set.

### SetEndTime

`func (o *InlineObject516) SetEndTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject516) SetEndTimeExplicitNull(b bool)`
...
`func (o *InlineObject516) GetStartTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetStartTime returns the StartTime field if non-nil, zero value otherwise.

### GetStartTimeOk

`func (o *InlineObject516) GetStartTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject516) HasStartTime() bool`

HasStartTime returns a boolean if a field has been set.

### SetStartTime

`func (o *InlineObject516) SetStartTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject516) SetStartTimeExplicitNull(b bool)`
...
`func (o *InlineObject516) GetAvailabilityViewInterval() int32`
...
`func (o *InlineObject516) GetAvailabilityViewIntervalOk() (int32, bool)`
...
`func (o *InlineObject516) HasAvailabilityViewInterval() bool`

HasAvailabilityViewInterval returns a boolean if a field has been set.

### SetAvailabilityViewInterval

`func (o *InlineObject516) SetAvailabilityViewInterval(v int32)`
...
`func (o *InlineObject516) SetAvailabilityViewIntervalExplicitNull(b bool)`
