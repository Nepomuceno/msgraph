...
`func (o *InlineObject232) GetSchedules() []string`

GetSchedules returns the Schedules field if non-nil, zero value otherwise.

### GetSchedulesOk

`func (o *InlineObject232) GetSchedulesOk() ([]string, bool)`
...
`func (o *InlineObject232) HasSchedules() bool`

HasSchedules returns a boolean if a field has been set.

### SetSchedules

`func (o *InlineObject232) SetSchedules(v []string)`

SetSchedules gets a reference to the given []string and assigns it to the Schedules field.

### GetEndTime

`func (o *InlineObject232) GetEndTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetEndTime returns the EndTime field if non-nil, zero value otherwise.

### GetEndTimeOk

`func (o *InlineObject232) GetEndTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject232) HasEndTime() bool`

HasEndTime returns a boolean if a field has been set.

### SetEndTime

`func (o *InlineObject232) SetEndTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject232) SetEndTimeExplicitNull(b bool)`
...
`func (o *InlineObject232) GetStartTime() AnyOfmicrosoftGraphDateTimeTimeZone`

GetStartTime returns the StartTime field if non-nil, zero value otherwise.

### GetStartTimeOk

`func (o *InlineObject232) GetStartTimeOk() (AnyOfmicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject232) HasStartTime() bool`

HasStartTime returns a boolean if a field has been set.

### SetStartTime

`func (o *InlineObject232) SetStartTime(v AnyOfmicrosoftGraphDateTimeTimeZone)`
...
`func (o *InlineObject232) SetStartTimeExplicitNull(b bool)`
...
`func (o *InlineObject232) GetAvailabilityViewInterval() int32`
...
`func (o *InlineObject232) GetAvailabilityViewIntervalOk() (int32, bool)`
...
`func (o *InlineObject232) HasAvailabilityViewInterval() bool`

HasAvailabilityViewInterval returns a boolean if a field has been set.

### SetAvailabilityViewInterval

`func (o *InlineObject232) SetAvailabilityViewInterval(v int32)`
...
`func (o *InlineObject232) SetAvailabilityViewIntervalExplicitNull(b bool)`
